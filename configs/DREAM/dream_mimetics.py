...
ann_file = '../data/mimetics/mimetics_dual.pkl'
...
data = dict(
    ...
    train={
        "rgb":dict(
            type='RepeatDataset',
            times=10,
            dataset=dict(type=dataset_type['rgb'], ann_file=ann_file, split='train', data_prefix='../data/mimetics/rawframes', pipeline=train_pipeline['rgb'], start_index=1)),
        "skeleton":dict(
            type='RepeatDataset',
            times=10,
    ...
    val={
        "rgb":dict(type=dataset_type['rgb'], ann_file=ann_file, split='test', data_prefix='../data/mimetics/rawframes', pipeline=val_pipeline['rgb'], start_index=1),
        "skeleton":dict(type=dataset_type['skeleton'], ann_file=ann_file, split='test', pipeline=val_pipeline['skeleton']),
    },
    test={
        "rgb":dict(type=dataset_type['rgb'], ann_file=ann_file, split='test', data_prefix='../data/mimetics/rawframes', pipeline=test_pipeline['rgb'], start_index=1),
